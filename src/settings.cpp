...
void RegisterQuackOauthSettings(DBConfig &config) {
	...
	config.AddExtensionOption(
	    ...
	    LogicalType::VARCHAR, Value("jwks"), nullptr, SetScope::GLOBAL);
	...
	config.AddExtensionOption(
	    ...
	    LogicalType::VARCHAR, Value("generic"), nullptr, SetScope::GLOBAL);
	...
	config.AddExtensionOption(
	    ...
	    LogicalType::INTEGER, Value::INTEGER(60), nullptr, SetScope::GLOBAL);
	...
	config.AddExtensionOption(
	    ...
	    LogicalType::INTEGER, Value::INTEGER(30), nullptr, SetScope::GLOBAL);
	...
	config.AddExtensionOption(
	    ...
	    LogicalType::VARCHAR, Value("deny"), nullptr, SetScope::GLOBAL);
